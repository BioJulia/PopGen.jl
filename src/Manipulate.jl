...
"""
    isolate_genotypes(data::PopObj; samples::Union{String, Array, Nothing}, loci::Union{String, Array, Nothing})
...
"""
function isolate_genotypes(data::PopObj; samples::Union{String, Array, Nothing}= nothing, loci::Union{String, Array, Nothing}= nothing)
...
function Base.missing(data::PopObj)
    ...
    sample_df = DataFrame(name = data.samples.name,
