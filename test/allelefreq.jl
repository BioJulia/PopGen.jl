...
@testset "Allele and Geno Freqs" begin
    ...
    @testset "geno counts" begin
        @test length(PopGen.geno_count_observed(cats.genodata.genotype)) == 295
        @test typeof(PopGen.geno_count_observed(cats.genodata.genotype)) <: Dict{<:Tuple,Int64}
        @test length(PopGen.geno_count_expected(cats.genodata.genotype)) == 6241
        @test typeof(PopGen.geno_count_expected(cats.genodata.genotype)) <: Dict{<:Tuple,Float64}

        @test length(PopGen.geno_count_observed(sharks.genodata.genotype)) == 12
        @test typeof(PopGen.geno_count_observed(sharks.genodata.genotype)) <: Dict{<:Tuple,Int64}
        @test length(PopGen.geno_count_expected(sharks.genodata.genotype)) == 25
        @test typeof(PopGen.geno_count_expected(sharks.genodata.genotype)) <: Dict{<:Tuple,Float64}
    end

    @testset "geno freqs" begin
        @test length(PopGen.geno_freq(cats.genodata.genotype)) == 295
        @test typeof(PopGen.geno_freq(cats.genodata.genotype)) <: Dict{<:Tuple,Float64}
        ...
        @test length(PopGen.geno_freq_expected(cats.genodata.genotype)) == 6241
        @test typeof(PopGen.geno_freq_expected(cats.genodata.genotype)) <: Dict{<:Tuple,Float64}
        ...
        @test length(PopGen.geno_freq(sharks.genodata.genotype)) == 12
        ...
        @test length(PopGen.geno_freq_expected(sharks.genodata.genotype)) == 25
        @test typeof(PopGen.geno_freq_expected(sharks.genodata.genotype)) <: Dict{<:Tuple,Float64}
